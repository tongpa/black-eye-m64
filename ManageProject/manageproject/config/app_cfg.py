# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in manageproject.
...
import manageproject
from manageproject import model
from manageproject.lib import app_globals, helpers 
...
base_config.package = manageproject
...
base_config.model = manageproject.model
base_config.DBSession = manageproject.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "a51ee70e-9448-4397-b7ef-afd07d3b0c82"
