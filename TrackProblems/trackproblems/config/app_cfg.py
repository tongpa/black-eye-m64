# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in TrackProblems.
...
base_config.model = trackproblems.model
base_config.DBSession = trackproblems.model.DBSession
# Configure the authentication backend

# YOU MUST CHANGE THIS VALUE IN PRODUCTION TO SECURE YOUR APP 
base_config.sa_auth.cookie_secret = "0d7aab26-02f7-4692-9945-1e2e362d64fe"
