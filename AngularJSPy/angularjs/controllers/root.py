...
from angularjs.controllers.angularcontroller import AngularController;
...
class RootController(BaseController):
    """
    The root controller for the angularjs application.
    ...
    @expose('angularjs.templates.index')
    def index(self):
        """Handle the front-page."""
        return dict(page='index')

    @expose('angularjs.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('angularjs.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('angularjs.templates.data')
    @expose('json')
    def data(self, **kw):
    ...
    @expose('angularjs.templates.login')
